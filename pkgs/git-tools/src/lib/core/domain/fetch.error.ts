...
const FETCH_REFS_NOT_FOUND_ERROR_TAG = Tag.make("domain", `FETCH_REFS_NOT_FOUND_ERROR`)
...
const FETCH_DEPTH_EXCEEDED_ERROR_TAG = Tag.make("domain", `FETCH_DEPTH_EXCEEDED_ERROR`)
