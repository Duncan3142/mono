...
import { type Fetch, Remote } from "#duncan3142/git-tools/core/domain"
...
interface FetchConfig {
	...
	readonly defaultDepth: Fetch.FetchDepth
	readonly defaultDeepenBy: Fetch.FetchDepth
}
...
class RepositoryConfig extends Effect.Service<RepositoryConfig>()(
	TagFactory.make(`config`, `repo-config`),
	{
...
export { RepositoryConfig, Default }
