...
describe("Integration", () => {
	it.scopedLive("executes", () =>
		Effect.gen(function* () {
			...
			expect(console.log).toHaveBeenNthCalledWith(11, expect.stringMatching(/^[a-f0-9]{40}\n$/))

			expect(console.log).toHaveBeenNthCalledWith(12, expect.stringMatching(/^[a-f0-9]{40}\n$/))
