...
<br />
<div align="center">
	<a href="https://github.com/Duncan3142/mono/pkgs/tsc-config">
...
<h3 align="center">TSC Config</h3>

<p align="center">
	TypeScript config
	<br />
	<a href="https://github.com/Duncan3142/mono/pkgs/tsc-config"><strong>Explore the docs</strong></a>
</p>
...
```sh
npm add -D @duncan3142/tsc-config
```

then reference the package in your `tsconfig.json`

```json
{
	"extends": "@duncan3142/tsc-config"
}
```
...
Project Link: [https://github.com/Duncan3142/mono/pkgs/tsc-config](https://github.com/Duncan3142/mono/pkgs/tsc-config)
